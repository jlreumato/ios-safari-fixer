    ...
    <section className="relative min-h-[100dvh] w-full overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-[100dvh] max-w-7xl flex-col justify-center px-4 pt-28 pb-20 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          <p className="mb-4 inline-block rounded-full border border-white/25 bg-white/10 -webkit-backdrop-filter backdrop-filter backdrop-blur-md px-4 py-1.5 text-[0.65rem] font-semibold uppercase tracking-[0.18em] text-[#e7d9b5] opacity-0 animate-[fadeInUp_0.6s_ease-out_0.1s_forwards]">
        ...
        <a
          href="#sobre"
          className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-2 text-xs font-medium uppercase tracking-[0.2em] text-white/70 transition-colors hover:text-white"
        >
          Role para explorar
